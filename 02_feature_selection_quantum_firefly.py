...
# ==========================================
# FEATURE SELECTION - QUANTUM FIREFLY OPTIMIZER
# ==========================================
...
class QuantumFireflyOptimizer:
    ...
    def __init__(self, model, X_train, y_train, X_val, y_val,
                 ...
                 randomness=0.3, quantum_factor=0.1, batch_size=32,
    ...
    def optimize(self, verbose=True, use_hybrid=True):
        if verbose:
            print("\n" + "="*60)
            print("FEATURE SELECTION - QUANTUM FIREFLY OPTIMIZER")
            print("="*60)
            print(f"\nConfiguration:")
