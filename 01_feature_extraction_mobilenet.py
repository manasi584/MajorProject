...
# ==========================================
# FEATURE EXTRACTION - MOBILENET + DCP
# ==========================================
...
def extract_features_mobilenet(dataset_path, csv_path, image_dir, pm25_max=None):
    """Extract MobileNetV2 features + Dark Channel Prior"""
    print("\n" + "="*60)
    print("FEATURE EXTRACTION - MOBILENET + DCP")
    print("="*60)
    ...
    model.eval()
    print("   MobileNetV2 loaded (feature extraction mode)")
    ...
    print(f"   MobileNetV2 features shape: {X.shape}")
...
if __name__ == "__main__":
    ...
    OUTPUT_PATH = "./features_mobilenet.npz"

    # Extract features
    X, DCP, y, PM25_MAX = extract_features_mobilenet(DATASET_PATH, CSV_PATH, IMAGE_DIR)
