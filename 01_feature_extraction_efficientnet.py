...
# ==========================================
# FEATURE EXTRACTION - EFFICIENTNET + DCP
# ==========================================
...
def extract_features_efficientnet(dataset_path, csv_path, image_dir, pm25_max=None):
    """Extract EfficientNet features + Dark Channel Prior"""
    print("\n" + "="*60)
    print("FEATURE EXTRACTION - EFFICIENTNET + DCP")
    print("="*60)
    ...
    print("\n2. Loading EfficientNet pre-trained model...")
    model = efficientnet_b0(weights=EfficientNet_B0_Weights.DEFAULT)
    model.classifier = nn.Identity()  # Remove classification head
    model = model.to(device)
    model.eval()
    print("   EfficientNet loaded (feature extraction mode)")

    # Image preprocessing (EfficientNet uses 224x224)
    ...
    print(f"   EfficientNet features shape: {X.shape}")
...
if __name__ == "__main__":
    ...
    OUTPUT_PATH = "./features_efficientnet.npz"

    # Extract features
    X, DCP, y, PM25_MAX = extract_features_efficientnet(DATASET_PATH, CSV_PATH, IMAGE_DIR)
