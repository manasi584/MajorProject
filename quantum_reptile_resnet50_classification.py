...
# CLASSIFICATION (AQI) - ResNet50 + DCP (2049-dim)
# ==========================================
...
# ==========================================
# FEATURE EXTRACTION (Dark Channel Prior + ResNet50)
# ==========================================
...
def extract_features(dataset_path, csv_path, image_dir, pm25_max=None):
    """Extract ResNet50 (2048-dim) + DCP (1-dim) features -> 2049-dim total"""
...
class QuantumMutationReptileOptimizer:
    ...
    def optimize(self):
        print("\nQuantum Mutation Reptile Search Algorithm (ResNet50 + DCP) Starting...\n")
...
if __name__ == "__main__":
    ...
    FEATURES_PATH = "./air_pollution_features_resnet50_dcp.npz"

    if os.path.exists(FEATURES_PATH):
        print("Loading pre-extracted ResNet50 + DCP features...")
        ...
        print("Extracting ResNet50 + DCP features (2049-dim)...")
    ...
    X_combined = np.concatenate([X, DCP], axis=1)  # (N, 2049)
    print(f"Input feature dim: {X_combined.shape[1]}")
    ...
    print("=" * 60)
    print("QUANTUM REPTILE (ResNet50 + DCP) - CLASSIFICATION RESULTS")
    print("=" * 60)
